...
export function MagicCard(props: MagicCardProps) {
  ...
  // TEMA via class <html>.dark (CortexClip memakai localStorage
  // "cortexclip-theme", bukan next-themes) — cukup amati class root.
  const [isDarkTheme, setIsDarkTheme] = useState(true)

  useEffect(() => {
    const rootEl = document.documentElement
    const update = () => setIsDarkTheme(rootEl.classList.contains("dark"))
    update()
