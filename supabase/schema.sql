...
\restrict quw9a98l0YODBsyD7B8OxJw409GvH0N4CBy0uT3Wj9cXXjYHz9rAjaa1YAE0gVo
...
--
-- Name: jaga_kolom_hak_profiles(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.jaga_kolom_hak_profiles() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
...
--
-- Name: ad_redemptions; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.ad_redemptions (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    user_id uuid NOT NULL,
    plan text NOT NULL,
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT ad_redemptions_plan_check CHECK ((plan = ANY (ARRAY['day'::text, 'week'::text, 'month'::text])))
);


--
-- Name: TABLE ad_redemptions; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.ad_redemptions IS 'Catatan setiap kali user menukar tontonan iklan menjadi premium.';
...
CREATE TABLE public.clips (
    ...
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    ass_content text,
    preview_style_hash text,
    preview_ready boolean DEFAULT false NOT NULL,
    preview_url text,
    overlay_plan jsonb,
    camera_track jsonb,
    layout_prefs jsonb,
    thumb_url text,
    editor_prefs jsonb,
    CONSTRAINT clips_status_check CHECK ((status = ANY (ARRAY['detected'::text, 'rendered'::text, 'failed'::text]))),
    CONSTRAINT clips_virality_score_check CHECK (((virality_score >= 0) AND (virality_score <= 100)))
);


--
-- Name: COLUMN clips.preview_url; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.clips.preview_url IS 'URL preview MP4 (absolut, https, domain produksi cortexclip.eu.cc).';


--
-- Name: COLUMN clips.overlay_plan; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.clips.overlay_plan IS 'Rencana overlay: [{time_start,time_end,category,genre,icon_id,side,animation,broll_url,emoji}] — sumber tunggal untuk preview & render.';


--
-- Name: COLUMN clips.camera_track; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.clips.camera_track IS 'Jalur kamera face tracking: {fps, src_w, crop_w, x[], cuts[], static_x}. Dipakai preview instan di browser + render, supaya analisis tidak diulang.';


--
-- Name: COLUMN clips.layout_prefs; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.clips.layout_prefs IS 'Auto layout: {"enabled":bool,"layouts":[...],"has_screenshare":bool,"has_gameplay":bool}';


--
-- Name: COLUMN clips.thumb_url; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.clips.thumb_url IS 'URL publik JPG frame klip (dibuat backend via ffmpeg range-read). NULL = belum ada.';
...
CREATE TABLE public.profiles (
    ...
    ad_target text,
    ad_credits_updated_at timestamp with time zone
);


--
-- Name: COLUMN profiles.ad_credits; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.profiles.ad_credits IS 'Jumlah iklan yang sudah ditonton untuk paket premium yang sedang dikejar (ad_target). Dipakai paket bulanan yang boleh dicicil.';


--
-- Name: COLUMN profiles.ad_target; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.profiles.ad_target IS 'Paket premium-lewat-iklan yang sedang dikejar: day | week | month. NULL = tidak sedang mengejar paket.';
...
CREATE TABLE public.projects (
    ...
    banner_url text,
    CONSTRAINT projects_source_type_check CHECK ((source_type = ANY (ARRAY['upload'::text, 'youtube'::text]))),
    CONSTRAINT projects_status_check CHECK ((status = ANY (ARRAY['pending'::text, 'uploading'::text, 'downloading'::text, 'transcribing'::text, 'analyzing'::text, 'rendering'::text, 'completed'::text, 'failed'::text])))
);


--
-- Name: COLUMN projects.genre; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.projects.genre IS 'Genre konten hasil deteksi AI: comedy|business|tech|education|sports|food|travel|music|gaming|lifestyle|drama|health|motivation';


--
-- Name: COLUMN projects.progress; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.projects.progress IS 'Progres 0-100 untuk tahap berjalan (transcribing/analyzing). Diisi backend.';
...
--
-- Name: admin_user_overview; Type: VIEW; Schema: public; Owner: -
--
...
CREATE VIEW public.admin_user_overview AS
 SELECT p.user_id,
    ...
    ( SELECT count(*) AS count
          ...
          WHERE (pr.user_id = p.user_id)) AS total_projects,
    ( SELECT count(*) AS count
           FROM public.clips c
          WHERE (c.user_id = p.user_id)) AS total_clips,
    ( SELECT count(*) AS count
           FROM public.usage_log ul
          WHERE ((ul.user_id = p.user_id) AND (ul.status = 'success'::text))) AS total_requests,
    ( SELECT count(*) AS count
           FROM public.usage_log ul
          WHERE ((ul.user_id = p.user_id) AND (ul.status = 'success'::text) AND (ul.created_at > (now() - '30 days'::interval)))) AS requests_30d,
        CASE
            WHEN (EXISTS ( SELECT 1
               FROM auth.identities i
              WHERE ((i.user_id = p.user_id) AND (i.provider = 'google'::text)))) THEN 'google'::text
            WHEN (COALESCE((u.raw_app_meta_data ->> 'provider'::text), ''::text) = 'google'::text) THEN 'google'::text
            ELSE COALESCE((u.raw_app_meta_data ->> 'provider'::text), 'email'::text)
...
--
-- Name: VIEW admin_user_overview; Type: COMMENT; Schema: public; Owner: -
--
...
CREATE TABLE public.caption_presets (
    ...
    user_id uuid NOT NULL,
    name text NOT NULL,
    accent_color text DEFAULT '#FFD400'::text NOT NULL,
    base_color text DEFAULT '#FFFFFF'::text NOT NULL,
    font_size integer DEFAULT 30 NOT NULL,
    words_per_line integer DEFAULT 3 NOT NULL,
    "position" integer DEFAULT 62 NOT NULL,
    stroke boolean DEFAULT true NOT NULL,
    show_overlays boolean DEFAULT true NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL
);
...
--
-- Name: model_stats; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.model_stats (
    provider text NOT NULL,
    model text NOT NULL,
    ok_total bigint DEFAULT 0 NOT NULL,
    fail_total bigint DEFAULT 0 NOT NULL,
...
--
-- Name: TABLE model_stats; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.model_stats IS 'Sukses/gagal kumulatif per endpoint AI Hydra. Ditulis backend (service key), dibaca panel admin.';


--
-- Name: premium_orders; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.premium_orders (
    ...
    CONSTRAINT premium_orders_plan_check CHECK ((plan = ANY (ARRAY['day'::text, '5day'::text, 'month'::text, 'year'::text]))),
    CONSTRAINT premium_orders_status_check CHECK ((status = ANY (ARRAY['pending'::text, 'completed'::text, 'failed'::text, 'expired'::text])))
);


--
-- Name: COLUMN premium_orders.expired_at; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.premium_orders.expired_at IS 'Kadaluarsa QRIS dari Pakasir (transactioncreate.payment.expired_at, UTC).';
...
CREATE TABLE public.publish_jobs (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT publish_jobs_platform_check CHECK ((platform = ANY (ARRAY['youtube'::text, 'tiktok'::text]))),
    CONSTRAINT publish_jobs_status_check CHECK ((status = ANY (ARRAY['scheduled'::text, 'rendering'::text, 'uploading'::text, 'published'::text, 'failed'::text, 'canceled'::text])))
);


--
-- Name: TABLE publish_jobs; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.publish_jobs IS 'Klip yang dijadwalkan tayang otomatis ke sosial media.';
...
CREATE TABLE public.social_accounts (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT social_accounts_platform_check CHECK ((platform = ANY (ARRAY['youtube'::text, 'tiktok'::text]))),
    CONSTRAINT social_accounts_status_check CHECK ((status = ANY (ARRAY['pending'::text, 'connected'::text, 'expired'::text, 'revoked'::text])))
);
...
COMMENT ON TABLE public.social_accounts IS 'Akun TikTok/YouTube tersambung untuk auto-publish. Token dipakai penjadwal server.';


--
-- Name: usage_log_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.usage_log_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: usage_log_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.usage_log_id_seq OWNED BY public.usage_log.id;
...
--
-- Name: usage_log id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.usage_log ALTER COLUMN id SET DEFAULT nextval('public.usage_log_id_seq'::regclass);
...
--
-- Name: ad_redemptions ad_redemptions_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ad_redemptions
    ADD CONSTRAINT ad_redemptions_pkey PRIMARY KEY (id);
...
--
-- Name: model_stats model_stats_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.model_stats
    ADD CONSTRAINT model_stats_pkey PRIMARY KEY (provider, model);


--
-- Name: premium_orders premium_orders_order_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.premium_orders
    ADD CONSTRAINT premium_orders_order_id_key UNIQUE (order_id);


--
-- Name: premium_orders premium_orders_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ad_redemptions_user_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ad_redemptions_user_idx ON public.ad_redemptions USING btree (user_id, created_at DESC);
...
--
-- Name: login_events_created_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX login_events_created_idx ON public.login_events USING btree (created_at DESC);


--
-- Name: login_events_user_idx; Type: INDEX; Schema: public; Owner: -
--
...
CREATE INDEX profiles_is_admin_idx ON public.profiles USING btree (is_admin) WHERE is_admin;
...
CREATE INDEX publish_jobs_due_idx ON public.publish_jobs USING btree (status, scheduled_at);


--
-- Name: publish_jobs_user_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: social_accounts_state_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX social_accounts_state_idx ON public.social_accounts USING btree (oauth_state) WHERE (oauth_state IS NOT NULL);


--
-- Name: social_accounts_user_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX social_accounts_user_idx ON public.social_accounts USING btree (user_id, platform);


--
-- Name: usage_log_created_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX usage_log_created_idx ON public.usage_log USING btree (created_at DESC);


--
-- Name: usage_log_kind_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX usage_log_kind_idx ON public.usage_log USING btree (kind, status);


--
-- Name: usage_log_model_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX usage_log_model_idx ON public.usage_log USING btree (model) WHERE (status = 'success'::text);


--
-- Name: usage_log_user_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX usage_log_user_idx ON public.usage_log USING btree (user_id, created_at DESC);
...
--
-- Name: profiles jaga_kolom_hak_profiles; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER jaga_kolom_hak_profiles BEFORE UPDATE ON public.profiles FOR EACH ROW EXECUTE FUNCTION public.jaga_kolom_hak_profiles();


--
-- Name: publish_jobs publish_jobs_touch; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: social_accounts social_accounts_touch; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: clips trg_touch_clips; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_touch_clips BEFORE UPDATE ON public.clips FOR EACH ROW EXECUTE FUNCTION public.touch_updated_at();


--
-- Name: projects trg_touch_projects; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_touch_projects BEFORE UPDATE ON public.projects FOR EACH ROW EXECUTE FUNCTION public.touch_updated_at();
...
--
-- Name: admin_requests admin_requests_requester_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.admin_requests
    ADD CONSTRAINT admin_requests_requester_id_fkey FOREIGN KEY (requester_id) REFERENCES auth.users(id) ON DELETE CASCADE;


--
-- Name: caption_presets caption_presets_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.caption_presets
    ADD CONSTRAINT caption_presets_user_id_fkey FOREIGN KEY (user_id) REFERENCES auth.users(id) ON DELETE CASCADE;


--
-- Name: clips clips_project_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: premium_orders premium_orders_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: publish_jobs publish_jobs_account_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.publish_jobs
    ADD CONSTRAINT publish_jobs_account_id_fkey FOREIGN KEY (account_id) REFERENCES public.social_accounts(id) ON DELETE CASCADE;


--
-- Name: publish_jobs publish_jobs_clip_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.publish_jobs
    ADD CONSTRAINT publish_jobs_clip_id_fkey FOREIGN KEY (clip_id) REFERENCES public.clips(id) ON DELETE CASCADE;


--
-- Name: publish_jobs publish_jobs_project_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.publish_jobs
    ADD CONSTRAINT publish_jobs_project_id_fkey FOREIGN KEY (project_id) REFERENCES public.projects(id) ON DELETE CASCADE;


--
-- Name: publish_jobs publish_jobs_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.publish_jobs
    ADD CONSTRAINT publish_jobs_user_id_fkey FOREIGN KEY (user_id) REFERENCES auth.users(id) ON DELETE CASCADE;


--
-- Name: render_jobs render_jobs_clip_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.render_jobs
    ADD CONSTRAINT render_jobs_clip_id_fkey FOREIGN KEY (clip_id) REFERENCES public.clips(id) ON DELETE CASCADE;


--
-- Name: render_jobs render_jobs_project_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: render_jobs render_jobs_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: share_tokens share_tokens_owner_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: share_tokens share_tokens_project_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.share_tokens
    ADD CONSTRAINT share_tokens_project_id_fkey FOREIGN KEY (project_id) REFERENCES public.projects(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.usage_log
    ADD CONSTRAINT usage_log_user_id_fkey FOREIGN KEY (user_id) REFERENCES auth.users(id) ON DELETE CASCADE;
...
--
-- Name: clips Users can delete own clips; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: caption_presets Users can delete own presets; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: clips Users can insert own clips; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: caption_presets Users can insert own presets; Type: POLICY; Schema: public; Owner: -
--
...
CREATE POLICY "Users can insert own profile" ON public.profiles FOR INSERT TO authenticated WITH CHECK (((auth.uid() = user_id) AND (COALESCE(plan, 'free'::text) = 'free'::text) AND (COALESCE(is_admin, false) = false) AND (premium_until IS NULL) AND (banned_until IS NULL) AND (COALESCE(ad_credits, 0) = 0) AND (COALESCE(watermark_removed, false) = false)));
...
--
-- Name: render_jobs Users can insert own render_jobs; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can insert own render_jobs" ON public.render_jobs FOR INSERT TO authenticated WITH CHECK ((auth.uid() = user_id));


--
-- Name: clips Users can read own clips; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: caption_presets Users can read own presets; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: render_jobs Users can read own render_jobs; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can read own render_jobs" ON public.render_jobs FOR SELECT TO authenticated USING ((auth.uid() = user_id));


--
-- Name: clips Users can update own clips; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: caption_presets Users can update own presets; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: premium_orders Users read own orders; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: caption_presets; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: login_events login_events read own; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "login_events read own" ON public.login_events FOR SELECT TO authenticated USING ((auth.uid() = user_id));


--
-- Name: model_stats; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.model_stats ENABLE ROW LEVEL SECURITY;

--
-- Name: publish_jobs own publish jobs; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "own publish jobs" ON public.publish_jobs USING ((auth.uid() = user_id)) WITH CHECK ((auth.uid() = user_id));


--
-- Name: social_accounts own social accounts; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "own social accounts" ON public.social_accounts USING ((auth.uid() = user_id)) WITH CHECK ((auth.uid() = user_id));


--
-- Name: premium_orders; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: share_tokens; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: usage_log usage_log read own; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "usage_log read own" ON public.usage_log FOR SELECT TO authenticated USING ((auth.uid() = user_id));
...
--
-- Name: objects Users can delete own uploads; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Users can delete own uploads" ON storage.objects FOR DELETE TO authenticated USING (((bucket_id = 'video-uploads'::text) AND ((storage.foldername(name))[1] = (auth.uid())::text)));


--
-- Name: objects Users can read own uploads; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Users can read own uploads" ON storage.objects FOR SELECT TO authenticated USING (((bucket_id = 'video-uploads'::text) AND ((storage.foldername(name))[1] = (auth.uid())::text)));


--
-- Name: objects Users can update own uploads; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Users can update own uploads" ON storage.objects FOR UPDATE TO authenticated USING (((bucket_id = 'video-uploads'::text) AND ((storage.foldername(name))[1] = (auth.uid())::text))) WITH CHECK (((bucket_id = 'video-uploads'::text) AND ((storage.foldername(name))[1] = (auth.uid())::text)));


--
-- Name: objects Users can upload to own folder; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Users can upload to own folder" ON storage.objects FOR INSERT TO authenticated WITH CHECK (((bucket_id = 'video-uploads'::text) AND ((storage.foldername(name))[1] = (auth.uid())::text)));
...
\unrestrict quw9a98l0YODBsyD7B8OxJw409GvH0N4CBy0uT3Wj9cXXjYHz9rAjaa1YAE0gVo
