...
from .layout_render import posisi_panel
...
def segmen_untuk(analisis: dict[str, Any],
    ...
    analisis: hasil face_pipeline.analyze() — perlu `layout_frames` & `analysis_fps`.
    ...
    # isi posisi panel (median cx per orang) untuk layout multi-panel
    for s in seg:
